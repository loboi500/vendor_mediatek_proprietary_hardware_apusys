...
/*for edma 2.0*/
int fillDescV0(st_edmaUnifyInfo *pInfo, void *edma_desc, void *headDesc)
{
    ...
    EDMA_LOG_INFO("fillDescV0 st_edmaDesc20 size = %zu, curr desc %p, head desc %p\n", sizeof(st_edmaDesc20), edma_desc, headDesc);
...
int fillDescData(st_edmaUnifyInfo *pInfo, void *edma_desc, void *headDesc)
{
    st_edmaDesc20 *pDesc = (st_edmaDesc20 *)edma_desc;
    ...
    EDMA_LOG_INFO("fillDescData [edma20] copy size = %d, curr desc %p, head desc %p\n", pIdata->copy_size, edma_desc, headDesc);
...
int fillDescNN(st_edmaUnifyInfo *shape, void *edma_desc, void *headDesc)
{
    EDMA_LOG_NONE("%s info_type = %d, edma_desc = %p, headDesc = %p\n",
        __func__, shape->info_type, edma_desc, headDesc);
...
{
    EDMA_LOG_WARN("%s not supported for info_type = %d, curr_desc = %p, head_desc = %p\n",
         __func__, pInfo->info_type, currDesc, headDesc);
    return -1;
}
...
int fillDescUFBC(st_edmaUnifyInfo *pInfo, void *edma_desc, void *headDesc)
{
    st_edmaDesc20 *pDesc = (st_edmaDesc20 *)edma_desc;
    st_edma_InputShape *shape = &pInfo->st_info.infoShape;
