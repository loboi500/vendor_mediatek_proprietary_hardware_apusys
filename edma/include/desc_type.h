...
enum DescType {
    descUnknown,
    descAsyncCopyTempl, // runtime copy 8 async copy templates to L1
    descKernelInstruction,
    descArgTable,
    descPrivateMem,
    descConstPool,
    descUserConst, // user copy __const

    /* DMA feature */
    descCopy,      // normal copy
    descFill,      // constant fill
    descRGB2ARGB
};
