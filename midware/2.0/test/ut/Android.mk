...
# test program build in debug load
...
LOCAL_HEADER_LIBRARIES += libapu_sample_headers
...
LOCAL_MODULE := apu_mdw_test
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_OWNER := mtk
LOCAL_PRELINK_MODULE := false
LOCAL_CFLAGS += -pedantic-errors -Wall -Wextra -Werror -fexceptions
LOCAL_MULTILIB = 64
LOCAL_MODULE_STEM_64 = apu_mdw_test64
